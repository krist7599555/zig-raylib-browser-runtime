...
var ASM_CONSTS = {
  113248: () => { if (document.fullscreenElement) return 1; },  
 113294: () => { return Module.canvas.width; },  
 113326: () => { return parseInt(Module.canvas.style.width); },  
 113374: () => { document.exitFullscreen(); },  
 113401: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 113474: () => { if (document.fullscreenElement) return 1; },  
 113520: () => { return Module.canvas.width; },  
 113552: () => { return screen.width; },  
 113577: () => { document.exitFullscreen(); },  
 113604: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 113737: () => { return window.innerWidth; },  
 113763: () => { return window.innerHeight; },  
 113790: () => { if (document.fullscreenElement) return 1; },  
 113836: () => { return Module.canvas.width; },  
 113868: () => { return parseInt(Module.canvas.style.width); },  
 113916: () => { if (document.fullscreenElement) return 1; },  
 113962: () => { return Module.canvas.width; },  
 113994: () => { return screen.width; },  
 114019: () => { return window.innerWidth; },  
 114045: () => { return window.innerHeight; },  
 114072: () => { if (document.fullscreenElement) return 1; },  
 114118: () => { return Module.canvas.width; },  
 114150: () => { return screen.width; },  
 114175: () => { document.exitFullscreen(); },  
 114202: () => { if (document.fullscreenElement) return 1; },  
 114248: () => { return Module.canvas.width; },  
 114280: () => { return parseInt(Module.canvas.style.width); },  
 114328: () => { document.exitFullscreen(); },  
 114355: ($0) => { Module.canvas.style.opacity = $0; },  
 114393: () => { return screen.width; },  
 114418: () => { return screen.height; },  
 114444: () => { return window.screenX; },  
 114471: () => { return window.screenY; },  
 114498: () => { return window.devicePixelRatio; },  
 114534: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 114587: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 114638: () => { Module.canvas.style.cursor = 'none'; },  
 114675: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 114931: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 114982: () => { if (document.pointerLockElement) return 1; },  
 115029: () => { if (document.fullscreenElement) return 1; },  
 115075: () => { return window.innerWidth; },  
 115101: () => { return window.innerHeight; }
};
...
var _game_set_title = Module['_game_set_title'] = makeInvalidEarlyAccess('_game_set_title');
var _game_update = Module['_game_update'] = makeInvalidEarlyAccess('_game_update');
var _game_get_title = Module['_game_get_title'] = makeInvalidEarlyAccess('_game_get_title');
var _game_log_info = Module['_game_log_info'] = makeInvalidEarlyAccess('_game_log_info');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['game_set_title'] != 'undefined', 'missing Wasm export: game_set_title');
  assert(typeof wasmExports['game_update'] != 'undefined', 'missing Wasm export: game_update');
  assert(typeof wasmExports['game_get_title'] != 'undefined', 'missing Wasm export: game_get_title');
  assert(typeof wasmExports['game_log_info'] != 'undefined', 'missing Wasm export: game_log_info');
  assert(typeof wasmExports['_initialize'] != 'undefined', 'missing Wasm export: _initialize');
  ...
  _game_set_title = Module['_game_set_title'] = createExportWrapper('game_set_title', 1);
  _game_update = Module['_game_update'] = createExportWrapper('game_update', 0);
  _game_get_title = Module['_game_get_title'] = createExportWrapper('game_get_title', 1);
  _game_log_info = Module['_game_log_info'] = createExportWrapper('game_log_info', 0);
