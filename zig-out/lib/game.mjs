...
var ASM_CONSTS = {
  113232: () => { if (document.fullscreenElement) return 1; },  
 113278: () => { return Module.canvas.width; },  
 113310: () => { return parseInt(Module.canvas.style.width); },  
 113358: () => { document.exitFullscreen(); },  
 113385: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 113458: () => { if (document.fullscreenElement) return 1; },  
 113504: () => { return Module.canvas.width; },  
 113536: () => { return screen.width; },  
 113561: () => { document.exitFullscreen(); },  
 113588: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 113721: () => { return window.innerWidth; },  
 113747: () => { return window.innerHeight; },  
 113774: () => { if (document.fullscreenElement) return 1; },  
 113820: () => { return Module.canvas.width; },  
 113852: () => { return parseInt(Module.canvas.style.width); },  
 113900: () => { if (document.fullscreenElement) return 1; },  
 113946: () => { return Module.canvas.width; },  
 113978: () => { return screen.width; },  
 114003: () => { return window.innerWidth; },  
 114029: () => { return window.innerHeight; },  
 114056: () => { if (document.fullscreenElement) return 1; },  
 114102: () => { return Module.canvas.width; },  
 114134: () => { return screen.width; },  
 114159: () => { document.exitFullscreen(); },  
 114186: () => { if (document.fullscreenElement) return 1; },  
 114232: () => { return Module.canvas.width; },  
 114264: () => { return parseInt(Module.canvas.style.width); },  
 114312: () => { document.exitFullscreen(); },  
 114339: ($0) => { Module.canvas.style.opacity = $0; },  
 114377: () => { return screen.width; },  
 114402: () => { return screen.height; },  
 114428: () => { return window.screenX; },  
 114455: () => { return window.screenY; },  
 114482: () => { return window.devicePixelRatio; },  
 114518: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 114571: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 114622: () => { Module.canvas.style.cursor = 'none'; },  
 114659: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 114915: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 114966: () => { if (document.pointerLockElement) return 1; },  
 115013: () => { if (document.fullscreenElement) return 1; },  
 115059: () => { return window.innerWidth; },  
 115085: () => { return window.innerHeight; }
};
